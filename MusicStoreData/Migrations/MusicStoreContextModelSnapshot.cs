...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MusicStoreData.Models.BusinesLogic.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MusicStoreData.Models.BusinesLogic.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<double>("ProductSuplierPrice")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("MusicStoreData.Models.CMS.AdminPolicies", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AdminPolicies", (string)null);
                });
            ...
            modelBuilder.Entity("MusicStoreData.Models.CMS.ControlActions", b =>
                {
                    ...
                    b.Property<string>("ControlSection")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ControlerUrl")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MusicStoreData.Models.CMS.CustomerQuery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CustomerQuery", (string)null);
                });
            ...
            modelBuilder.Entity("MusicStoreData.Models.CMS.MusicStoreAddress", b =>
                {
                    ...
                    b.Property<bool>("IsItCurrentStore")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("MusicStoreAddress", (string)null);
                });
            ...
            modelBuilder.Entity("MusicStoreData.Models.CMS.NewsAndArticles", b =>
                {
                    ...
                    b.ToTable("NewsAndArticles", (string)null);
                });
            ...
            modelBuilder.Entity("MusicStoreData.Models.CMS.Newslatter", b =>
                {
                    ...
                    b.ToTable("Newslatter", (string)null);
                });

            modelBuilder.Entity("MusicStoreData.Models.CMS.OpeningHours", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("MusicStoreAddressId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MusicStoreAddressId");

                    b.ToTable("OpeningHours", (string)null);
                });

            modelBuilder.Entity("MusicStoreData.Models.CMS.OrderStatuses", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MusicStoreData.Models.CMS.PaymentStatuses", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MusicStoreData.Models.CMS.Subscribers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MusicStoreData.Models.CMS.Subscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Descriptions = "Sign Up For Newsletter",
                            MoreInfo = "Sign up for our mailing list to get the latest updates and offers",
                            Name = "Confesor123@gmail.com",
                            Position = 1,
                            isActive = true
                        });
                });
            ...
            modelBuilder.Entity("MusicStoreData.Models.CMS.WebHeaders", b =>
                {
                    ...
                    b.ToTable("WebHeaders", (string)null);
            ...
            modelBuilder.Entity("MusicStoreData.Models.ShoppingCart.Report", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal?>("TotalAcusticGuitars")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("TotalAmplifiers")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("TotalBassGuitars")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("TotalClasicalGuitars")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("TotalElectricGuitars")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("TotalOtherGuitars")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("TotalStrings")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("MusicStoreData.Models.Store.TechInfo", b =>
                {
                    ...
                    b.ToTable("TechInfos", (string)null);
                });
            ...
            modelBuilder.Entity("TeaStoreApp.Models.BookmarkedProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("BookmarkedProduct", (string)null);
                });
            ...
            modelBuilder.Entity("MusicStoreData.Models.BusinesLogic.OrderItem", b =>
                {
                    b.HasOne("MusicStoreData.Models.BusinesLogic.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("MusicStoreData.Models.CMS.OpeningHours", b =>
                {
                    b.HasOne("MusicStoreData.Models.CMS.MusicStoreAddress", "Store")
                        .WithMany("OpeningHours")
                        .HasForeignKey("MusicStoreAddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
