...
using static MusicStore.ViewModels.RoleManagmentVM;
...
namespace MusicStore.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public IActionResult RoleManagment(string userId)
        {
            ...
            {
                ApplicationUser = _unitOfWork.ApplicationUser.Get(u => u.Id == userId, include: q => q.Include(u => u.Company)),
        ...
        public IActionResult GetAll()
        {
            List<ApplicationUser> objUserList = _unitOfWork.ApplicationUser.GetAll(
                include: q => q.Include(au => au.Company)).ToList();
